...
class PlannedTimeBased implements PlannedSetValues {
  const PlannedTimeBased({required this.durationSeconds, final  String? $type}): $type = $type ?? 'timeBased';
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlannedTimeBased&&(identical(other.durationSeconds, durationSeconds) || other.durationSeconds == durationSeconds));
}
...
@override
String toString() {
  return 'PlannedSetValues.timeBased(durationSeconds: $durationSeconds)';
}
