        ...
        Expanded(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                _LibraryLinkSection(draft: draft, bloc: bloc),
                const SizedBox(height: AppSpacing.lg),
                TextField(
...
class _LibraryLinkSection extends StatelessWidget {
  const _LibraryLinkSection({required this.draft, required this.bloc});
