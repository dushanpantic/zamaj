...
### 1.9 No back-press guard on unsaved editors
...
| b | P1 | Back gesture discards changes silently — no `PopScope` guard. Combined with (a), this is the most error-prone editor in the app. |
